...
import { X, Phone, MapPin, Clock, Send, CheckCircle2, Facebook, Instagram } from 'lucide-react';
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-4 sm:p-6">
      <motion.div
        ...
        className="w-full max-w-3xl bg-neutral-900 border border-white/15 rounded-3xl overflow-hidden shadow-2xl text-white p-6 sm:p-8 max-h-[90vh] overflow-y-auto"
      >
        <div className="flex items-center justify-between pb-4 border-b border-white/10">
          <div>
            <span className="text-xs font-semibold text-emerald-400 uppercase tracking-wider block">
              Visit or Call Our Concierge
            </span>
            <h3 className="text-2xl font-bold font-['Outfit',sans-serif]">Contact Connect Holidayss</h3>
          </div>
          <button
            onClick={onClose}
